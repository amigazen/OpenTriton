...
int main(void)
{
  if(TR_OpenTriton(TRITON11VERSION,TRCA_Name,"ToolManagerGUIDemo1",TRCA_LongName,"ToolManager GUI demo 1",TRCA_Info,"Looks like the original ToolManager",TAG_END))
  {
    TR_AutoRequestTags(Application,NULL,
      WindowID(0), WindowPosition(TRWP_BELOWTITLEBAR),
      WindowTitle("ToolManager GUI demo 1"), WindowFlags(TRWF_NOSIZEGADGET|TRWF_NODELZIP|TRWF_NOZIPGADGET|TRWF_NOESCCLOSE),
      WindowBackfillNone,
